<html lang="en-us">
<head>
    <script type="text/javascript" async="" src="https://static.criteo.net/js/ld/publishertag.prebid.136.js"></script><script src="https://securepubads.g.doubleclick.net/pagead/managed/js/gpt/m202403200101/pubads_impl_page_level_ads.js?cb=31082134"></script><script type="text/javascript" async="" src="https://script.4dex.io/localstore.js?upapi=true"></script><script src="https://cdn.hadronid.net/hadron.js?url=https%3A%2F%2Fwww.shorturl.at%2F&amp;ref=&amp;_it=amazon&amp;partner_id=436"></script><script type="text/javascript" async="" src="https://script.4dex.io/localstore.js"></script>
    <meta charset="utf-8">
...
<body><div id="cmpbox2" class="cmpboxBG cmpstyleroot" style="display: none;"></div><div id="cmpbox" class="cmpbox cmpstyleroot cmpboxclosed cmpbox3" aria-modal="true" role="dialog" lang="EN" aria-labelledby="cmpboxheadline1" data-nosnippet="" style="display: none;"></div>
<header>
    <div id="logo"><a href="{{ url('/url-minimizer') }}" class="logo">Short URL</a></div>
</header>
<main>
    @if ($errors->any())
    ...
    <section id="urlbox">
        ...
        <form action="{{ url('/minimize') }}" method="post">
            @csrf
            <div id="formurl">
                <div>
                    ...
                    <input style="width: 200px; display: block;" type="text" id="expiry" name="expiry" placeholder="Select expiry date">
                </div>
                <div id="formbutton">
